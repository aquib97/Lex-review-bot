...
def index():
    try:
        #if request.json['product_name'] is not None:
        #print(type(request.json))
        searchString = str(request.json).replace(" ","") #['product_name'].replace(" ","")
        print(searchString)
        ...
        #print(prod_html)
        commentboxes = prod_html.find_all('div', {'class': "_16PBlm"}) #_16PBlm
        print(commentboxes)
